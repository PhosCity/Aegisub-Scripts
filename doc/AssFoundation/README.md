...
| hasBeenDeleted  | if the line has been marked for deletion | bool    |
| inserted        | if the line has been inserted            | bool    |
| selected        | if the line is under selection           | bool    |
